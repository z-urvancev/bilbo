...
- Если LLM недоступна, ключ не задан, либо модель уперлась в лимит (`429`), бот автоматически использует локальный fallback-совет.
- Для более стабильной работы можно использовать `OPENROUTER_MODEL=openrouter/auto` или добавить резервные модели.
